...
studentDataset_mat[which(studentDataset_mat$Medu==1),7] = "one"
studentDataset_mat[which(studentDataset_mat$traveltime==1),13] = "one"
studentDataset_mat[which(studentDataset_mat$Fedu==1),8] = "one"
studentDataset_mat[which(studentDataset_mat$studytime==1),14] = "one"
studentDataset_mat[which(studentDataset_mat$famrel==1),24] = "one"
studentDataset_mat[which(studentDataset_mat$freetime==1),25] = "one"
studentDataset_mat[which(studentDataset_mat$goout==1),26] = "one"
studentDataset_mat[which(studentDataset_mat$Walc==1),28] = "one"
studentDataset_mat[which(studentDataset_mat$Dalc==1),27] = "one"
studentDataset_mat[which(studentDataset_mat$health==1),29] = "one"
